...
public class Ventana extends JFrame {
    ...
    public void Limpiar() {
        nombreL.setText("");//El texto queda vacío, para facilitar el reingreso de datos.
        matriculaL.setText("");
        carreraL.setText("");
        correoL.setText("");
}
    ...
    public JLabel getMatriculaL() {
        return matriculaL;
    }

    public void setMatriculaL(JLabel matriculaL) {
        this.matriculaL = matriculaL;
    }

    public JLabel getCarreraL() {
        return carreraL;
    }

    public void setCarreraL(JLabel carreraL) {
    ...
    public JTextField getCarreraTF() {
        return carreraTF;
    }

    public void setCarreraTF(JTextField carreraTF) {
        this.carreraTF = carreraTF;
    }
